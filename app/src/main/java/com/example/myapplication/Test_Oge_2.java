...
public class Test_Oge_2 extends AppCompatActivity implements GenerateLayout.SomeListener2 {
    ...
    //Self var
    String Module = "002"; //Модуль - это критерий по которому генерируются только вариации одного номера заданий из огэ
