...
public class Test_Oge_4 extends AppCompatActivity implements GenerateLayout.SomeListener2 {
    ...
    //Self var
    String Module = "004"; //Модуль - это критерий по которому генерируются только вариации одного номера заданий из огэ
