...
public class Test_Oge_7 extends AppCompatActivity implements GenerateLayout.SomeListener2 {
    ...
    //Self var
    String Module = "007"; //Модуль - это критерий по которому генерируются только вариации одного номера заданий из огэ
