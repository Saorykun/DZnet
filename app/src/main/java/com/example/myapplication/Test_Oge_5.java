...
public class Test_Oge_5 extends AppCompatActivity implements GenerateLayout.SomeListener2 {
    ...
    //Self var
    String Module = "005"; //Модуль - это критерий по которому генерируются только вариации одного номера заданий из огэ
